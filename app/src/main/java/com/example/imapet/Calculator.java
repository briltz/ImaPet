...
public class Calculator extends AppCompatActivity {
    ...
    public int petYearCalc(int humanAge, int petWeight, String spnChoice) {
        ...
        btnCalculate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
               ...
               if (humanAge <= 20) {
                    ...
                    petYearCalc(humanAge, petWeight, spnChoice);
    ...
    public void viewHistory() {
        btnView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                retrieval = calculatorDB.getAllData();
        ...
        btnDelete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               // Cursor deletion = calculatorDB.deleteAllData();
                deletion = calculatorDB.deleteAllData();
