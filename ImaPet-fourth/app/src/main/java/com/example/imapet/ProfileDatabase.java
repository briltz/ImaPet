...
public class ProfileDatabase extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        sqLiteDatabase.execSQL("create table " + NAME_OF_TABLE + "(Username TEXT PRIMARY KEY, ProfileName TEXT, Status TEXT, ALittleAboutMe TEXT, Birthday TEXT)");
    }
    ...
    public boolean insertProfileData (String username, String profileName, String status, String aboutMe, String birthday) {
